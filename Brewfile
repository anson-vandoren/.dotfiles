# Install mas first to allow installing apps from Mac App Store
brew "mas"
...
cask "macdown"  # markdown editor with previewer
cask "ngrok"    # reverse SSH proxy
cask "opera"    # browser
cask "qlcolorcode"  # formatting for QuickLook color syntax
...
brew "gnupg"    # GPG for signing git commits
brew "go"       # Go programming language
brew "httpie"   # easier to use than curl
brew "hub"      # CLI for creating new repos in GitHub
